...
# Figure 5A - PCoA Plot diet & TRF study 
...
# Figure 5B - dbRDA diet & TRF study 
...
for (ii in 1:ncol(meta_dbRDA)) {  
  ...
  R2adj <- RsquareAdj(dbrda)[[2]]  # Extract adjusted R²
...
# Figure 5C - dbRDA diet & TRF study controlled for project

## 1. Preparation

as in Figure 5B, 1. Preparation
...
Barplot - all variables, controlled for project = Figure S4 A
```{r}
variable_colors <- c("Diet/Feeding" = "#7690a0", "Experimental" = "#92ab93", "Genotype" = "#e5e1d9", "QMP" = "#a38e8e")
...
# Figure 5D - QMP - Taxa Correlation
