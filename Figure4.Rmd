...
```{r}
meta_TRF <- metadata_QP_interval %>% filter(project == "TRF_study") # 181 samples
...
# Figure 4B - Shannon Index per interval
...
Related to Figure S3 A&B (GLMMs) and Script "Suppl_GLMMs.Rmd"
