...
# Figure S3 A&B - GLMMs per interval 
...
get_df_for_taxon <- function(select_taxon) {
  L6_relAb_glmm_clr %>% 
    ...
    dplyr::mutate(diet = fct_relevel(diet, "control", "TRF"), # change for your project, order levels -> the first one called will be used as reference
                  timepoint = fct_relevel(timepoint, "30min", "90min", "150min"), # same for this -> list reference first
...
# Figure S4 B&C - GLMMs to compare HFiD and TRF 
