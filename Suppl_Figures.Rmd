...
# Figure S1 A - GLMM diet
see Suppl_GLMM.Rmd 

# Figure S1 B - Mouse body weight diet study 
...
# Figure S2 A - QMPs Clock Disruption
...
# Figure S2 B - Mouse body weight TRF study 
## 1. Preparation
```{r}
...
# Figure S2 C - Shannon Index TRF study
...
# Figure S2 D - PCoA Plot TRF study
...
# Figure S2 D - GLMM TRF study
see Suppl_GLMM.Rmd

# Figure S3 A&B - GLMM Interval Diet & TRF study 
see Suppl_GLMM.Rmd

# Figure S4 A - study-controlled dbRDA 
see Figure5.Rmd (Figure 5C)

# Figure S4 B&C - GLMM HFiD&TRF 
see Suppl_GLMM.Rmd
